...
Set objTextFile = objFSO.OpenTextFile("C:\xampp\htdocs\Projetos\Sistemas\LogoonLogoff\log\logoff.LOG", ForAppending, True)
...
recordSet.Open "INSERT INTO `logon` (`codigo`, `tipo`, `usuario`, `Computador`, `datahora`) VALUES (NULL, 'logoff', '" & strUserName & "','" & strComputerName & "', '" & DateInfo & "');", connection
